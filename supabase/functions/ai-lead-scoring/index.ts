...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Analise estes leads de uma loja de cosméticos (Lumera) e classifique-os. Para cada lead, retorne um score (0-100) e uma sugestão de ação concisa em português brasileiro.
