...
export default function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const orderData = {
        order_number: `MEC-${Date.now()}`, // Temporary, will be overwritten by trigger
            ...
            {paymentMethod === 'transfer' && (
              <Card className="mb-6 text-left">
                ...
                <CardContent className="space-y-2 text-sm">
                  ...
                  <p><strong>Titular:</strong> Meca Store S.A.</p>
                  <p><strong>Cuenta:</strong> 1234567890</p>
                  <p><strong>Monto:</strong> {formatPrice(total)}</p>
                  <p className="text-muted-foreground mt-4">
                    Envía el comprobante a nuestro WhatsApp para confirmar tu pedido.
                  </p>
                </CardContent>
              </Card>
            )}
                      ...
                      <div className="flex items-center space-x-3 p-4 rounded-lg border border-border hover:bg-muted/50 cursor-pointer">
                        ...
                        <Label htmlFor="transfer" className="flex-1 cursor-pointer">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Recibe los datos para transferir después de confirmar
                          </p>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-3 p-4 rounded-lg border border-border hover:bg-muted/50 cursor-pointer">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {shippingCost === 0 && (
                      <p className="text-xs text-primary">¡Envío gratis por compras mayores a ₲ 500.000!</p>
                    )}
                    <Separator />
